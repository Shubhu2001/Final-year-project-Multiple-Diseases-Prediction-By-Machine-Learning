...
urlpatterns = [
    path('admin/', admin.site.urls),
                  ...
                  path('delete_searched_disease/<int:pid>', delete_searched_disease, name="delete_searched_disease"),
                  path('delete_searched/<int:pid>', delete_searched, name="delete_searched"),
                  
                  path('view_search_disease_detection', view_search_disease_detection, name="view_search_disease_detection"),
                  ...
                  path('predict_diabetes_desease/<str:pred>/<str:accuracy>/', predict_diabetes_desease, name="predict_diabetes_desease"),
                  ...
                  path('diabetes_detection', diabetes_detection, name="diabetes_detection"),
